      ...
      <div className="footer">
        ...
        <div className="footer__block">
          <div className="footer__social-media-wrapper">
            ...
            <div>
              <a href="https://bitcointalk.org/index.php?topic=4542248" target="_blank" rel="nofollow noopener">
                <Icon name="bitcoin" className="fab footer__social-media-icon" />
              </a>
              <a href="https://discord.gg/Bz8ejJP" target="_blank" rel="nofollow noopener">
                <Icon name="discord" className="fab footer__social-media-icon" />
              </a>
              <a href="https://t.me/cryptonodesCNMC" target="_blank" rel="nofollow noopener">
                <Icon name="telegram" className="fab footer__social-media-icon" />
              </a>
              <a href="https://github.com/cryptonodes-core" target="_blank" rel="nofollow noopener">
                <Icon name="github" className="fab footer__social-media-icon" />
              </a>
              <a href="https://twitter.com/CryptonodesC" target="_blank" rel="nofollow noopener">
